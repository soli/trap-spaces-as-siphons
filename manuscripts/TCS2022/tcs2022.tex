...
\begin{table}[!htb]
  ...
  \begin{tabular}{rlrrrrrrrrr}
    ...
    \cmidrule(rr){8-11}
    & model & \(n\) & \(|M|\) & LQM & PBN & \texttt{mpbn} & SAT & CP & ILP & ASP \\
    \midrule
...
\begin{table}[!htb]
  ...
  \begin{tabular}{rrrrrrrr}
    ...
    & & & & \multicolumn{4}{c}{\texttt{Trappist}}\\
    \cmidrule(rr){5-8}
    \(n\) & \texttt{LQM} & \texttt{mpbn} & \texttt{PBN} & SAT & CP & ILP & ASP \\
    \midrule
