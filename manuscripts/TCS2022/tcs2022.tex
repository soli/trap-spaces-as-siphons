...
\begin{figure}[ht]
	...
	}; \addlegendentry{\texttt{Trappist-maxSAT}}
	...
	}; \addlegendentry{\texttt{Trappist-ASP}}
	
	\end{semilogxaxis}
	\end{tikzpicture}
	\caption{Cumulative numbers of random models solved by the competing methods with respect to enumerating the first 1000 minimal trap spaces.}
