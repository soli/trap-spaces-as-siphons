...
%		}; \addlegendentry{\texttt{CP}}
	...
	\end{semilogxaxis}
	\end{tikzpicture}
	\caption{Cumulative numbers of the \texttt{BBM} models that have less than 1000 minimal trap spaces (above) and \texttt{BBM} models (below) solved by the compared methods with respect to enumerating the first 1000 minimal trap spaces.}
	\label{fig:BBM_cumul}
\end{figure}
