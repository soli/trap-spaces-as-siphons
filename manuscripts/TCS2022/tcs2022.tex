...
\begin{table}[!htb]
  \caption{Timing comparisons (in seconds) between \texttt{bioLQM} (LQM), \texttt{PyBoolNet} (PBN), \texttt{mpbn} and the four variants of Trappist on the \texttt{PyBoolNet} repository.}
  \centering%
...
\begin{table}[!htb]
  \caption{Timing comparisons (in seconds) between \texttt{bioLQM} (LQM), \texttt{PyBoolNet} (PBN), \texttt{mpbn} and the four variants of Trappist on selected models from the literature.}
