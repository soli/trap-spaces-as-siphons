...
Indeed, the computation of stable motif is a bottleneck of the methods proposed in~\cite{Rozum2021}.}
...
\change{Such trap spaces (along with minimal trap space) are used in the phenotype control method~\cite{cifuentes2020control}.
This method uses the prime implicant-based method to compute trap spaces, which has been shown inefficient.
...
Many reduction techniques on Boolean networks~\cite{DBLP:journals/tcs/NaldiRTC11,schwieger2023reduction} have been proposed and some of them fully preserve attractors of a Boolean network under the fully asynchronous Boolean networks.
...
Second, although these reduction techniques can reduce the number of nodes, they can also increase the complexity of Boolean update functions~\cite{DBLP:journals/tcs/NaldiRTC11}, which is also an importan factor.
