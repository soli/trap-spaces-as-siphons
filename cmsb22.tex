...
To assess the efficiency of the proposed method, we compared it with the state-of-the-art method PyBoolNet~\cite{klarner2017pyboolnet} on both its own repository of models and on large models from the literature.
...
\begin{table}[!htb]
  ...
  \begin{tabular}{lrrrrrr}
    ...
    Alzheimer~\cite{aghamiri2020automated} & 762 & 237 & 1000+ & DNF & 1.03 & DNF\\
...
Note that for all the cases where PyBoolNet did not manage to finish before the timeout, as marked by ``DNF'' in Table~\ref{tab:result_real}, the timeout occurred during the computation of the prime-invariants.
