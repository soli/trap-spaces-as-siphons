...
However, this method is only applicable for \emph{locally-monotonic} Boolean models, whereas the prime-implicants based method~\cite{klarner2015computing} is applicable for general Boolean models (i.e.. including both locally-monotonic and non-locally-monotonic Boolean models).
The study~\cite{DBLP:journals/tcs/NoualRS13} highlights the need of non-locally-monotonic Boolean models in both biological and theoretical aspects.
...
\revise{Note that mpbn does not give any answer because that model is not locally-monotonic.}
