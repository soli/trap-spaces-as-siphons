...
Petri nets were introduced in the 60s as a simple formalism for describing and analyzing information processing systems that are characterized as being concurrent, asynchronous, non-deterministic and possibly distributed~\cite{peterson1981petri,Murata1989}.
...
\begin{table}[!htb]
  \caption{Timing comparisons between the proposed method and PyBoolNet on the PyBoolNet's repository.
    ...
    ``DNF'' means that the method did not finish the computation (with a maximum of 1000 trap spaces) within the timeout of 2 minutes. A number in bold indicates a ratio greater than three.}
  \centering
...
\begin{table}[!htb]
  \caption{Timing comparisons between the proposed method and PyBoolNet on selected models from the literature.
    Columns \(n\) and \(s\) denote the numbers of nodes (resp.\ input nodes) of each model. Column \(|M|\) denotes the number of minimal trap spaces and for each method is given the computation time in seconds.
    ``DNF'' means that the method did not finish the computation (stopping at the first 1000 minimal trap spaces, or all for the last column) within the timeout of 2 minutes.}
  \centering
  ...
  \begin{tabular}{lrrrrrr}
    ...
    \cmidrule(lr){6-7}
    model & \(n\) & \(s\) & \(|M|\) & first 1000 & first 1000 & all \\
    \midrule
    inflammatory-bowel-disease & 47 & 0 & 1 & DNF & 21.90 & 25.75\\
    T-LGL-survival-network-2008 & 61 & 7 & 318 & 0.73 & 0.14 & 0.14\\
    butanol-production & 66 & 13 & 8192 & 0.59 & 0.13 & 0.64\\
    colitis-associated-colon-cancer & 70 & 1 & 10 & 0.16 & 0.08 & 0.06\\
    mast-cell-activation & 73 & 19 & 1000+ & 0.64 & 0.15 & DNF\\
    IL-6-signalling & 86 & 15 & 32768 & 3.30 & 0.10 & 5.06\\
    Corral-ThIL-17-diff & 92 & 16 & 1000+ & DNF & 0.38 & DNF\\
    Korkut-2015 & 99 & 12 & 18556 & DNF & 0.61 & 5.01\\
    adhesion-cip-migration-cell-cycle & 121 & 4 & 78 & 40.81 & 0.33 & 0.45\\
    interferon-1 & 121 & 55 & 1000+ & 8.36 & 0.19 & DNF\\
    TCR-TLR5-signaling-2018 & 130 & 5 & 48 & 0.88 & 0.12 & 0.11\\
    influenza-virus-replication-cycle & 131 & 11 & 10128 & 63.62 & 0.21 & 1.95\\
    signaling-in-prostate-cancer & 133 & 11 & 2760 & DNF & 0.32 & 0.72\\
    HIV-1-with-T-cell-signaling & 138 & 14 & 39424 & DNF & 0.87 & 7.72\\
    signal-transduction-in-fibroblasts & 139 & 9 & 1000+ & DNF & 0.56 & DNF\\
    HMOX-1-pathway & 145 & 56 & 1000+ & 5.16 & 0.18 & DNF\\
    kynurenine-pathway & 150 & 72 & 1000+ & DNF & 0.74 & DNF\\
    virus-replication-cycle & 154 & 25 & 1000+ & DNF & 0.19 & DNF\\
    immune-system & 164 & 13 & 1000+ & DNF & 0.67 & DNF\\
    RA-apoptosis & 180 & 59 & 1000+ & DNF & 0.16 & DNF\\
    MAPK & 181 & 37 & 1000+ & 68.62 & 0.64 & DNF\\
    er-stress & 182 & 75 & 1000+ & 28.65 & 0.21 & DNF\\
    cascade-3 & 183 & 0 & 1 & 92.75 &  0.65 & 0.83\\
    CHO-2016 & 200 & 13 & 13312 & DNF & 1.01 & 1.99\\
    T-cell-check-point & 218 & 14 & 1000+ & 37.40 & 0.35 & DNF\\
    ErbB-receptor-signaling & 247 & 22 & 1000+ & DNF & 1.07 & DNF\\
    signaling-macrophage-activation & 321 & 19 & 1000+ & 15.82 & 0.63 & DNF\\
    cholocystokinin & 383 & 74 & 1000+ & 1.22 & 0.73 & DNF\\
    Alzheimer & 762 & 237 & 1000+ & DNF & 1.03 & DNF\\
    KEGG-network & 1659 & 521 & 1000+ & DNF & 44.85 & DNF\\
    human-network & 1953 & 669 & 1000+ & DNF & 42.97 & DNF\\
    SN-5 & 2746 & 829 & ??? & DNF & DNF & DNF\\
    turei-2016 & 4691 & 1257 & ??? & DNF & DNF & DNF\\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!htb]
  \caption{Timing comparisons between the proposed method and PyBoolNet on selected models from the literature.
    Columns \(n\) and \(s\) denote the numbers of nodes (resp.\ input nodes) of each model. For each method, Column \(|M|\) denotes the number of minimal trap spaces and the computation time is given in seconds.
    ``DNF'' means that the method did not finish the computation within the timeout of 2 minutes.}
  \centering
  \label{tab:selected_new_option}
  \begin{tabular}{lrrrrrr}
    \toprule
    & & & \multicolumn{2}{c}{PyBoolNet} & \multicolumn{2}{c}{Trappist} \\
    \cmidrule(lr){4-5} \cmidrule(lr){6-7}
    model & \(n\) & \(s\) & \(|M|\) & time (s) & \(|M|\) & time (s) \\
    \midrule
    inflammatory-bowel-disease & 47 & 0 & 0+ & DNF & 1 & 25.75 \\
    T-LGL-survival-network-2008 & 61 & 7 & 318 & 0.73 & 318 & 0.14 \\
    ErbB-receptor-signaling & 247 & 22 & 0+ & DNF & 1456394+ & DNF \\
    SN-5 & 2746 & 829 & 0+ & DNF & 0+ & DNF \\
    \bottomrule
  \end{tabular}
\end{table}

\vangiang{What do you think about the following option? We do not set a limit for the number of minimal trap space but a limit of 2 minutes for the computation time. There will be 4 cases (see Table~\ref{tab:selected_new_option}). Case 1: both methods finished (e.g., the T-LGL-survival-network-2008 model). In this case, we compare the computation time between two methods. Case 2: PyBoolNet finished and Trappist did not finish. In this case, PyBoolNet is of course better than Trappist (but no model for this case). Case 3: PyBoolNet did not finish and Trappist finished (e.g., the inflammatory-bowel-disease). In this case, Trappist is of course better than PyBoolNet. Moreover, 0+ indicates that PyBoolNet even failed at the computation of prime-implicants. Case 4: both method did not finish (e.g., the ErbB-receptor-signaling model). In this case, we compare the numbers of minimal trap spaces obtained by the two methods within the timeout (more is better). Moreover, 0+ also indicates that Trappist even failed at the conversion to PNML models.}
...
\begin{table}[!htb]
  ...
  \centering
  \label{tab:selected_original_option}
  \begin{tabular}{lrrrrrr}
    \toprule
    & & & \multicolumn{2}{c}{PyBoolNet} & \multicolumn{2}{c}{Trappist} \\
    \cmidrule(lr){4-5} \cmidrule(lr){6-7}
    model & \(n\) & \(s\) & \(|M|\) & time (s) & \(|M|\) & time (s) \\
    \midrule
    inflammatory-bowel-disease & 47 & 0 & 0+ & DNF & 1 & 21.90 \\
    T-LGL-survival-network-2008 & 61 & 7 & 318 & 0.73 & 318 & 0.14 \\
    SN-5 & 2746 & 829 & 0+ & DNF & 0+ & DNF \\
    \bottomrule
  \end{tabular}
...
\vangiang{Original option: We set a limit of 1000 for the number of minimal trap spaces and a limit of 2 minutes for the computation time. There will be 4 cases (see Table~\ref{tab:selected_original_option}). Case 1: both methods finished (e.g., the T-LGL-survival-network-2008 model). In this case, we simply compare the computation time between two methods. Case 2: PyBoolNet finished and Trappist did not finish. In this case, PyBoolNet is of course better than Trappist (but no model for this case). Case 3: PyBoolNet did not finish and Trappist finished (e.g., the inflammatory-bowel-disease). In this case, Trappist is of course better than PyBoolNet. Moreover, 0+ indicates that PyBoolNet even failed at the computation of prime-implicants. Case 4: both methods did not finish. In this case, we consider the following subcases. Case 4-1: PyBoolNet is 0+ and Trappist is 0+ (e.g., the SN-5 model), i.e., PyBoolNet failed at the computation of prime-implicants and Trappist failed at the conversion to PNML models. Case 4-2: PyBoolNet is 0+ and Trappist is 1000+ (no model for this case), i.e., Trappist is better than PyBoolNet. Case 4-3: PyBoolNet is 1000+ and Trappist is 0+ (no model for this subcase), i.e., PyBoolNet is better than Trappist. Case 4-4: PyBoolNet is 1000+ and Trappist is 1000+ (no model for this case), i.e., we cannot compare between PyBoolNet and Trappist.}
