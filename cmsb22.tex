...
\revise{The first observation is that for 27 of the 33 models (more than 78\%), mpbn did not give any answer because it recognized that these models are not locally-monotonic.
For 6 of the 33 models where mpbn returned the answers, mpbn and Trappist are comparable in computation time.
Along with the fact that mbpn can handle only locally-monotonic models and Trappist can handle general models, it is less insightful to further compare between them.
