...
For 5 of the 29 models, mpbn does not give any answer since these models are not locally-monotonic.
...
\begin{table}[!htb]
  ...
  \begin{tabular}{rlrrrrrrr}
    ...
    \midrule
    \rownb & inflammatory-bowel-disease~\cite{DBLP:journals/bmcsb/HelikarKMBRMWSLR12} & 47 & 0 & 1 & DNF & NM & 0.82 & 0.69\\
    \rownb & T-LGL-survival-network-2008~\cite{DBLP:journals/bmcsb/HelikarKMBRMWSLR12} & 61 & 7 & 318 & 0.84 & NM & 0.01 & 0.01\\
    \rownb & butanol-production~\cite{DBLP:journals/bmcsb/HelikarKMBRMWSLR12} & 66 & 13 & 8192 & 0.71 & NM & 0.02 & 0.02\\
    \rownb & colitis-associated-colon-cancer~\cite{DBLP:journals/bmcsb/HelikarKMBRMWSLR12} & 70 & 1 & 10 & 0.20 & NM & 0.01 & 0.01\\
    ...
    \rownb & adhesion-cip-migration-cell-cycle~\cite{guberman2020boolean} & 121 & 4 & 78 & 36.80 & 0.35 & 0.08 & 0.09\\
    \rownb & interferon-1~\cite{ostaszewski2021covid19} & 121 & 55 & >1000 & 10.11 & NM & 0.02 & DNF\\
    \rownb & TCR-TLR5-signaling-2018~\cite{rodriguez2019cooperation} & 130 & 5 & 48 & 2.06 & NM & 0.03 & 0.02\\
    \rownb & influenza-virus-replication-cycle~\cite{DBLP:journals/bmcsb/HelikarKMBRMWSLR12} & 131 & 11 & 10128 & 46.67 & NM & 0.03 & 0.02\\
    \rownb & signaling-in-prostate-cancer~\cite{Montagud2021} & 133 & 11 & 2760 & DNF & NM & 0.05 & 0.04\\
    \rownb & HIV-1-with-T-cell-signaling~\cite{DBLP:journals/bmcsb/HelikarKMBRMWSLR12} & 138 & 14 & 39424 & DNF & NM & 0.03 & 0.06\\
    \rownb & signal-transduction-in-fibroblasts~\cite{helikar2008emergent} & 139 & 9 & >1000 & DNF & NM & 0.06 & DNF\\
    ...
    \rownb & signaling-macrophage-activation~\cite{DBLP:journals/bmcsb/HelikarKMBRMWSLR12} & 321 & 19 & >1000 & 16.43 & NM & 0.04 & DNF\\
...
However, the current method appears to perform very well even on the biggest models we have considered.
We thus plan to propose its inclusion in the CoLoMoTo effort to make it readily available to modellers.

\sylvain{Question of reviewer 3:
Thanks to the performance improvement coming with Trappist, we now do know for sure that logical models may come with an overwhelming number of trap spaces, often exceeding 1000, which leaves the intriguing question how to evaluate these 1000 or more (even with Trappist so far not always computable) attractors/phenotypes?}
