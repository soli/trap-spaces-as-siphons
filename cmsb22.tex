...
Note that for all the cases wher PyBoolNet did not manage to finish before the timeout, as marked by ``DNF'' in Table~\ref{tab:selected_redone}, the timeout occurred during the computation of the prime-invariants.
Hence, not even a single minimal trap-space was output by the method.
