...
\author{Van-Giang Trinh\inst{1}\orcidID{0000-0001-6581-998X} \and \\
  Kunihiko Hiraishi\inst{3}\orcidID{0000-0003-1750-1891} \and \\
...
\sylvain{This section might be better with real ``Definitions'', but when I tried rewriting it, this led to a lot of changes\dots I guess we can do that for the journal version but for now keep things as they are.}
\vangiang{Yes. This should be better. We can do that for the journal version.}
...
The second observation is that\dots
