...
\sylvain{This section might be better with real ``Definitions'', but when I tried rewriting it it led to a lot of changes\dots I guess we can do that for the journal version but for now keep things as they are.}
